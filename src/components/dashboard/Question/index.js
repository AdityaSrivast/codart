...
import {Grid, Button, Snackbar,Dialog,DialogActions,
    DialogContent,Chip,DialogContentText,DialogTitle, CircularProgress} from '@material-ui/core';
...
class Questions extends Component {
    ...
    submit = () => {
        this.setState({results:{},disablebtn:true})
            ...
            if(extension && extension.length>0) {
                ...
                if(extensions.includes(extension)) {
                    ...
                    .then(resp=> {
                        ...
                        console.log(results);
                        this.setState({results,disablebtn:false});
                ...
                // displaying error for extensions
                    ...
                    typeSnackbar: 'error',disablebtn:false});
                }
            }
        }
        else {
            ...
            <div>
                    ...
                    <Grid container spacing={24} >
                        <Grid item lg={8} xs={7}>
                            ...
                            <Grid container spacing={0}>
                                ...
                                <Grid style={{textAlign:'right'}} item lg={5} xs={4}>
                                    <Chip
                                        style={{border:"1px solid #FE5151",minWidth:120}}
                                        label={<b>Points Scored:{(problem)?problem.point: ''}</b>}
                                        variant="outlined"
                                    />&nbsp;
                                    <Chip
                                        style={{border:"1px solid #FE5151",width:120}}
                                        label={<b>{(problem && problem.level)?problem.level.toUpperCase() : ''}</b>}
                                        variant="outlined"
                                    />
                                </Grid>
                            </Grid>
                        ...
                        <Grid item lg={4} xs={5} style={{padding:0}}>
                        ...
                        <Grid container spacing={24}>
                            <Grid item lg={6} xs={6}>
                                {done?<div/>:<Button className="submit-btn"
                                            style={{pointerEvents:this.state.disablebtn?'none':'auto'}}
                                            onClick={this.state.disablebtn?()=>{}:this.submit}
                                >{this.state.disablebtn? <CircularProgress 
                                    style={{color: '#fff'}} />:
                ...
                <Dialog
                    ...
                    <DialogContent>
                        ...
                        Note that every team is allowed to skip 3 questions with a time gap of 20 minutes. Once you reached your count, you won't be able to skip any quesion.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
            ...
            <div>
                ...
                <div className="question-section">
                    ...
                    <Grid container spacing={24}>
                        ...
                        <h2 className="heading">It's time to throw the Dart! 🎯</h2>
